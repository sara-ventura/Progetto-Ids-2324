...
public class ServiziRichieste {
    ...
    public void creaRichiestaCaricamento(UtenteStandard autore, EntitaRichiesta entitaRichiesta, Comune comune) {
    ...
    public void creaRichiestaModificaTesto(UtenteStandard autore, EntitaRichiesta entitaRichiesta, Comune comune, String modifica, TipoModificaTesto tipoModifica) {
    ...
    public void creaRichiestaModificaPeriodoTempo(UtenteStandard autore, PoiTemporaneo poiTemporaneo, Comune comune, LocalDateTime dataApertura, LocalDateTime dataChiusura) {
    ...
    public void creaRichiestaModificaOrario(UtenteStandard autore, Poi poi, Comune comune, int giorno, LocalTime orarioApertura, LocalTime orarioChiusura) {
    ...
    public void creaRichiestaCaricamentoContenutoContest(UtenteStandard autore, Contenuto contenuto, Contest contest, Comune comune) {
